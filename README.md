...
## CLEAR CODE CHALLENGE DELIVERABLES:
1. Gotta create all models and migrations correctly
2. Create all controllers and make all index and show methods
3. Sucessfully build a create OR edit
4. One validation
